...
ArDroneBundle.prototype.video = function(ipAddress, port, delay, isAbsolute) {
    this.commands.push(newCommand(delay, isAbsolute, 'video',
				  [ipAddress, port]));
    return this;
};

ArDroneBundle.prototype.ftrim = function(delay, isAbsolute) {
    this.commands.push(newCommand(delay, isAbsolute, 'ftrim',
				  []));
    return this;
};

ArDroneBundle.prototype.calibrate = function(delay, isAbsolute) {
    this.commands.push(newCommand(delay, isAbsolute, 'calibrate',
				  []));
    return this;
};
...
ArDroneBundle.prototype.animate = function(animation, duration, delay,
                                           isAbsolute) {
    this.commands.push(newCommand(delay, isAbsolute, 'animate',
				  [animation, duration]));
    return this;
};
