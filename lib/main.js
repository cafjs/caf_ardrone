...
exports.collapseMask = navData.collapseMask;
exports.expandMask = navData.expandMask;
exports.DRONE_STATES =  navData.DRONE_STATES;

var gpsData = require('./GPSData');

var wifiData = require('./WifiData');
exports.ArDroneWifiData = wifiData.ArDroneWifiData;
...
var client = exports.client = function(spec) {
    ...
    return {
        ...
        wifiData: wifiData.createWifiData(spec),
        time: time
    };
};
